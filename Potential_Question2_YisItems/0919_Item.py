...
def tokenize_MbRecord_FirstandSecondNumber(Qdata_Item, All_group):
...
#All_group = All_FirstandSecondNumber[['單品名稱','FirstNumber']]
    ...
    All_group_unique = np.append( All_group_unique, [1001, 1002]) # 1001=空值, 1002=未見過的群號
...
# In[]: 呼叫tokenize_MbRecord_FirstandSecondNumber，生成各個月份的 Mb Item Sparse Table
...
for month in range(1,13):
    for weekday in ["WD","WE"]:
        ...
        #First Number
        MbItemSparseTableFirstNumber[str_temp]  = tokenize_MbRecord_FirstandSecondNumber(Qdata_Item = data_temp, 
        ...
        #Second Number     
        MbItemSparseTableSecondNumber[str_temp]  = tokenize_MbRecord_FirstandSecondNumber(Qdata_Item = data_temp, 
