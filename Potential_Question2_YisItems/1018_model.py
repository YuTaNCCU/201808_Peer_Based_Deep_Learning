...
# In[]:M1     relu + sigmoid binary_crossentropy
...
for i in range(0,1) :
    ...
    model1.summary()
    modelcallbacks = model1.fit(x = train_x3, y = train_x3_01,
...
valid_y3_hat_01 = np.where(valid_y3_hat_inverse_transform> 0.1, 1, 0)
...
print(' Train ')
Scatterplot_RP( M1_performance_table, NUll_performance_table, lower = 0, upper = 50 ) 
print(' Valid' )
...
for i in range(1,2):   
    ...
    modelcallbacks3_1 = model3.fit(x = [train_x1,train_x2,train_x3,train_x1,train_x2,train_x3], 
                                   y = train_x3_01,
                    epochs=5+5, batch_size=64, shuffle=True,
                    validation_data=([train_x1,train_x2,train_x3,train_x1,train_x2,train_x3], 
                                     train_y3_True_01,),
                       callbacks=[EarlyStopping(monitor='loss', patience=3, verbose=0, mode='auto')])
...
#model3=load_model('M2_model_weights_2018-10-17-23_07_35_263561.h5',custom_objects={'fbeta_score':fbeta_score, 'my_mean_squared_error': my_mean_squared_error, 'my_mean_absolute_error':my_mean_absolute_error})

# In[]: temp
""""list_temp=['M3_model_weights_2018-10-17-17_58_03_037731.h5', 'M3_model_weights_2018-10-17-18_05_29_161515.h5', 
           'M3_model_weights_2018-10-17-18_13_20_511006.h5', 'M3_model_weights_2018-10-17-18_28_37_948550.h5', 
           'M3_model_weights_2018-10-17-18_22_09_627142.h5', 'M3_model_weights_2018-10-17-18_42_47_914207.h5',
           'M3_model_weights_2018-10-17-18_37_29_931695.h5', 'M3_model_weights_2018-10-17-18_58_10_569476.h5',
           'M3_model_weights_2018-10-17-18_49_17_706630.h5', 'M3_model_weights_2018-10-17-19_16_17_297906.h5', 
           'M3_model_weights_2018-10-17-19_07_34_884144.h5', 'M3_model_weights_2018-10-17-19_22_11_543447.h5',
           'M3_model_weights_2018-10-17-19_30_59_299232.h5', 'M3_model_weights_2018-10-17-19_45_54_330116.h5', 
           'M3_model_weights_2018-10-17-19_39_42_022287.h5']
list_temp=['M3_model_weights_2018-10-17-16_53_41_998731.h5','M3_model_weights_2018-10-17-17_09_25_261036.h5','M3_model_weights_2018-10-17-17_19_25_764321.h5','M3_model_weights_2018-10-17-17_32_35_161263.h5']
for i in range(0, len(list_temp)):
    print(list_temp[i])
    model3=load_model(list_temp[i],custom_objects={'fbeta_score':fbeta_score, 'my_mean_squared_error': my_mean_squared_error, 'my_mean_absolute_error':my_mean_absolute_error})
    temp(model3)
def temp(model3):"""
        
train_y3_hat = model3.predict([  train_x1,train_x2,train_x3,train_x1,train_x2,train_x3]) #M3
