...
#暫時處理
Item["M11WE"].loc[:,"0"] =Item["M11WE"].loc[:,"0"] +Item["M11WE"].loc[:,"1000095"]
Item["M11WE"] = Item["M11WE"].drop(columns=["1000095"])
Item["M11WD"].loc[:,"0"] =Item["M11WD"].loc[:,"0"] +Item["M11WD"].loc[:,"1000095"]
Item["M11WD"] = Item["M11WD"].drop(columns=["1000095"])

Item["M12WE"].loc[:,"0"] =Item["M12WE"].loc[:,"0"] +Item["M12WE"].loc[:,"1000095"]+Item["M12WE"].loc[:,"1000154"]+Item["M12WE"].loc[:,"1000285"]
Item["M12WE"] = Item["M12WE"].drop(columns=["1000095","1000154","1000285"])
Item["M12WD"].loc[:,"0"] =Item["M12WD"].loc[:,"0"] +Item["M12WD"].loc[:,"1000095"]+Item["M12WD"].loc[:,"1000154"]+Item["M12WD"].loc[:,"1000285"]
Item["M12WD"] = Item["M12WD"].drop(columns=["1000095","1000154","1000285"])
...
train_x1 = (Item["M7WD"]+ Item["M8WD"]+ Item["M9WD"]+ Item["M7WE"]+ Item["M8WE"]+ Item["M9WE"]).values
train_x1 = min_max_scaler.fit_transform(train_x1)

train_y1 = (Item["M10WD"]+ Item["M10WE"]).values
train_y1 = min_max_scaler.fit_transform(train_y1)

valid_x1 = (Item["M10WD"]+ Item["M8WD"]+ Item["M9WD"]+ Item["M10WE"]+ Item["M8WE"]+ Item["M9WE"]).values
valid_x1 = min_max_scaler.fit_transform(valid_x1)

valid_y1 = (Item["M11WD"]+ Item["M11WE"]).values
valid_y1 = min_max_scaler.fit_transform(valid_y1)
...
# In[]: y_predict
y_predict = model.predict(x = train_x1)
