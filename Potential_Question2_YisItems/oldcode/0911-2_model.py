...
#train_y1_01_hat = model.predict(train_x1) 

valid_y1_inverse_transform = Scaler_valid_y1.inverse_transform( valid_y1 )
valid_y1_hat = Scaler_valid_y1.inverse_transform( model.predict(valid_x1) )
# In[]: 生成預測值
...
sns.distplot( d/c, bins=None) #precision
