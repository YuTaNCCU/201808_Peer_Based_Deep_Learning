...
M3_temp = M1_performance_table.Predict1_of_true1 
...
for i in range(0,1) :
    ...
    #model1=load_model('save_M1_model_weights_2018-09-20-08_57_45_810670.h5',custom_objects={'fbeta_bce_loss':fbeta_bce_loss,'my_mean_squared_error': my_mean_squared_error, 'my_mean_absolute_error':my_mean_absolute_error})
...
for i in range(5,6) :
   ...
   # modelcallbacks2_1 = model2.fit(x = [train_x1, train_x2, train_x3], y = train_x3_01,
           #            epochs=i, batch_size=64, shuffle=True,
...
#model2=load_model('M2_model_weights_2018-10-17-07_32_16_569367.h5',custom_objects={'my_mean_squared_error': my_mean_squared_error, 'my_mean_absolute_error':my_mean_absolute_error})
# In[]: 2.M2生出預測值
#以下三個模型選一個來生出預測值:--------------------------
...
for i in range(1,2):   
    ...
    model3.compile(loss = "binary_crossentropy", optimizer =  adam, metrics=[my_mean_absolute_error]) #mean_absolute_error
    model3.summary()
    modelcallbacks3_1 = model1.fit(x = train_x3, y = train_x3_01,
                    epochs=5, batch_size=64, shuffle=True,
                    validation_data=(train_x3, train_y3_True_01,))
    #modelcallbacks3_2 = model1.fit(x = train_x3, y = train_y3_True_01,
     #               epochs=5, batch_size=64, shuffle=True,
      #              validation_data=(valid_x3, valid_y3_True_01,))
    SummarizeHistory(modelcallbacks)
