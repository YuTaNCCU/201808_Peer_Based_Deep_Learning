...
for i in range(1,2):   
    ...
    #model3=load_model('save_M3_model_weights_2018-10-17-15_39_39_932639.h5',custom_objects={'fbeta_score':fbeta_score, 'my_mean_squared_error': my_mean_squared_error, 'my_mean_absolute_error':my_mean_absolute_error})
...
train_y3_hat = model3.predict([  train_x1_cul,train_x2_cul,train_x3_cul]) #M3
