...
def Generate_Item_CorrCoef(y_true, y_pred):
...
M3_Item_corrcoef = Generate_Item_CorrCoef(y_true=train_y3_inverse_transform, y_pred=train_y3_hat_M2_inverse_transform)
...
#看哪一個模型好
df_temp = pd.DataFrame(data={'0':cross_entropy0,'1':cross_entropy1,'2':cross_entropy2,'3':cross_entropy3})
